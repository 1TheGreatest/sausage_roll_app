// Class representing a mock API service.
class MockApiService {
  // Asynchronous method to fetch sausage roll data.
  Future<List<Map<String, dynamic>>> fetchSausageRollData() async {
    // Simulating a network delay of 2 seconds.
    // Useful for testing loading states in the UI.
    await Future.delayed(const Duration(seconds: 2));

    // This data mimics the structure of a typical API response.
    return [
      {
        "articleCode": "1000446",
        "shopCode": "1234",
